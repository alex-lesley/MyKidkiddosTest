...
public class Constants {
    ...
    public static final String ARABIC_COLLECTION_PAGE_URL = "https://kidkiddos.com/collections/arabic";
    public static final String BULGARIAN_COLLECTION_PAGE_URL = "https://kidkiddos.com/collections/bulgarian";
    public static final String ARABIC_EBOOKS_PAGE_URL = "https://kidkiddos.com/collections/ebooks-in-arabic";
    public static final String CHINESE_EBOOKS_PAGE_URL = "https://kidkiddos.com/collections/ebooks-in-chinese-mandarin";
    public static final String SPANISH_COLLECTION_PAGE_URL = "https://kidkiddos.com/collections/spanish";
    public static final String FRENCH_COLLECTION_PAGE_URL = "https://kidkiddos.com/collections/french";
    public static final String CHINESE_COLLECTION_PAGE_URL = "https://kidkiddos.com/collections/chinese";
    ...
    public static final String SPANISH_COLLECTION_PAGE_HEADER = "//h1[contains(text(), 'Spanish')]";
    public static final String FRENCH_COLLECTION_PAGE_HEADER = "//h1[contains(text(), 'French')]";
    public static final String CHINESE_COLLECTION_PAGE_HEADER = "//h1[contains(text(), 'Mandarin Chinese')]";
    public static final String ARABIC_COLLECTION_PAGE_HEADER = "//h1[contains(text(), 'Arabic')]";
    public static final String ARABIC_EBOOKS_COLLECTION_PAGE_HEADER = "//h1[contains(text(), 'eBooks in Arabic')]";
    public static final String CHINESE_EBOOKS_COLLECTION_PAGE_HEADER = "//h1[contains(text(), 'eBooks in Chinese Mandarin')]";
    public static final String BULGARIAN_COLLECTION_PAGE_HEADER = "//h1[contains(text(), 'Bulgarian')]";
    ...
    public static final String BLOG_PAGE_RESOURCES_LINK = "//a[text()='Blog'][@class='site-nav__link site-nav__child-link']";
    public static final String SPANISH_COLLECTION_PAGE_LINK = "//a[@href='/collections/spanish'][@class='site-nav__link site-nav__link--main']";
    public static final String FRENCH_COLLECTION_PAGE_LINK = "//a[@href='/collections/french'][@class='site-nav__link site-nav__link--main']";
    public static final String CHINESE_COLLECTION_PAGE_LINK = "//a[@href='/collections/chinese'][@class='site-nav__link site-nav__link--main']";
